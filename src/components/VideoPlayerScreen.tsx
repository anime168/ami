      ...
      >
        ...
        {loadError && (
          <div className="absolute inset-0 flex flex-col items-center justify-center gap-3 text-center">
            ...
            <p className="text-sm font-semibold text-white">Unable to load this video</p>
            <p className="max-w-xs text-xs text-white/50">
              The video file may be missing or corrupted. Try another episode.
            </p>
            <button
              onClick={onBack}
        ...
        >
          ...
          <h2 className="mt-1 text-xl font-bold text-white">
            {show.type === 'movie' ? show.title : `Episode ${episode.episode_number}: ${episode.title}`}
          </h2>
        </div>
