      ...
      <div className="relative z-10 flex min-h-screen flex-col">
        ...
        <div className="mx-auto w-full max-w-lg flex-1 px-5 py-8">
          ...
          <div className="flex flex-col items-center">
            ...
            <p className="mt-3 text-xs text-white/40">Tap the camera to change your photo</p>
          </div>
          ...
          <div className="mt-10 space-y-4">
            ...
            <div className="rounded-2xl border border-white/10 bg-white/[0.03] p-4">
              ...
              {saved && (
                <p className="mt-2 text-xs text-[#22C55E]">Name updated</p>
              )}
            </div>
          ...
          >
            ...
            <div className="flex-1">
              <p className="text-sm font-bold text-white">Video Management</p>
              <p className="text-xs text-white/50">Upload videos, add episodes, manage content</p>
            </div>
